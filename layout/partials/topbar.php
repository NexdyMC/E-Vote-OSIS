    ...
    <nav class="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-brand-darkblue/90 backdrop-blur-md border-t border-slate-800 px-2 py-2">
        
        <!-- Navbar : Navigation mobile bottom -->
        <div class="flex justify-center items-center gap-2 w-full">
          <a href="voting.php" 
            class="inline-flex items-center gap-1.5 px-4 py-4 text-md w-1/2 justify-center font-bold transition-all <?= $activePage === 'voting' ? 'text-brand-darkblue bg-gradient-to-br to-amber-500 from-amber-300 rounded-lg shadow-md' : 'text-slate-300 hover:text-brand-yellow' ?>">
            <i data-lucide="bar-chart-3" class="w-6 h-6"></i>Voting
          </a>
          <a href="hasil.php"  
            class="inline-flex items-center gap-1.5 px-4 py-4 text-md w-1/2 justify-center font-bold transition-all <?= $activePage === 'hasil' ? 'text-brand-darkblue bg-gradient-to-br to-amber-500 from-amber-300 rounded-lg shadow-md' : 'text-slate-300 hover:text-brand-yellow' ?>">
            <i data-lucide="vote" class="w-6 h-6"></i>Hasil
          </a>
        </div>
    </nav>