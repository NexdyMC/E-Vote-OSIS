...
<style>
  ...
  .card-dashed:hover { border-color: #2563EB; background-color: #EEF3FF; transform: translateY(-4px); }
  ...
  /* ---------- Modal (dipakai oleh kandidat.php & siswa.php) ---------- */
  .modal-hidden { pointer-events: none; }
  .modal-hidden .modal-overlay-bg { opacity: 0; }
  .modal-hidden .modal-panel { transform: translateY(16px) scale(.97); opacity: 0; }
  .modal-overlay-bg, .modal-panel { transition: opacity .25s ease, transform .25s ease; }
